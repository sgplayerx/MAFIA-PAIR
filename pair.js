...
async function MAFIA_MD_BOT_PAIR_CODE(id, num, res) {
...
Use this code to create your own *MAFIA_MD-BOT* WhatsApp User Bot. 🤖
...
`;
                    await sock.sendMessage(sock.user.id, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                title: "MAFIA-MD-BOT",
                                thumbnailUrl: "https://files.catbox.moe/ldg6o2.jpg",
                                sourceUrl: "https://whatsapp.com/channel/0029Vb6f33lIyPtcEr6X6c0H",
                                mediaType: 2,
...
Use this code to create your own *MAFIA-MD-BOT* WhatsApp User Bot. 🤖
...
router.get('/', async (req, res) => {
    ...
    await KHISHAM-x-TUHEED-MD-BOT_PAIR_CODE(id, num, res);
});
